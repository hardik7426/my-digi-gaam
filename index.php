...
<head>
    ...
    <style>
        :root { --header-bg: #ffffff; --card-bg: rgba(255, 255, 255, 0.95); --primary-text: #1a202c; --secondary-text: #718096; --accent-color-1: #3182ce; --accent-color-2: #38b2ac; --shadow-color: rgba(0, 0, 0, 0.1); }
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .grid-item::before { content: ''; position: absolute; top: 0; left: 0; width: 100%; height: 4px; background: linear-gradient(90deg, var(--accent-color-1), var(--accent-color-2)); opacity: 0; transition: opacity 0.3s ease; }
        .grid-item:hover { transform: translateY(-8px) scale(1.02); box-shadow: 0 15px 30px rgba(0, 0, 0, 0.2); }
...
<body>
    <header class="main-header">
        ...
        <span>સ્વાગત છે, <?php echo htmlspecialchars($_SESSION['username']); ?>! | <a href="logout.php"><i class="fa-solid fa-right-from-bracket"></i> લોગઆઉટ</a></span>
    </header>
