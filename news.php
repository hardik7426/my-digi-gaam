...
<head>
    ...
    <title>ખોરાસા સમાચાર - માય ડિજી ગામ</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* === NEWS FEED CONTAINER UPDATED WITH GLASS EFFECT === */
        .news-feed {
            max-width: 900px;
            margin: 40px auto;
            padding: 30px 40px;
        ...
        .card-title { font-size: 1.5rem; font-weight: 700; color: var(--primary-text); margin-bottom: 15px; }
        .card-meta { display: flex; align-items: center; flex-wrap: wrap; gap: 20px; font-size: 0.9rem; color: var(--secondary-text); margin-bottom: 20px; padding-bottom: 20px; border-bottom: 1px solid #e2e8f0; }
        .meta-item { display: flex; align-items: center; }
        .meta-item i { margin-right: 8px; color: var(--accent-color-1); }
        .meta-item a { color: var(--accent-color-1); text-decoration: none; font-weight: 500; }
        .meta-item a:hover { text-decoration: underline; }
        .card-description { font-size: 1rem; line-height: 1.8; color: var(--secondary-text); }
        .card-footer { background-color: #f7fafc; border-top: 1px solid #e2e8f0; padding: 20px 30px; }
...
<body>
    <header class="main-header">
        <h1><i class="fa-solid fa-newspaper"></i> ખોરાસા સમાચાર</h1>
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-meta">
                            <div class="meta-item">
                                ...
                                <span><strong>તારીખ:</strong> <?php echo date('d M, Y', strtotime($row['publish_date'])); ?></span>
                            </div>
                            <?php if (!empty($row['source_name'])): ?>
                            <div class="meta-item">
                                <i class="fa-solid fa-newspaper"></i>
                                <span><strong>સ્ત્રોત:</strong> 
                                    <?php if (!empty($row['source_link'])): ?>
                                        <a href="<?php echo htmlspecialchars($row['source_link']); ?>" target="_blank" rel="noopener noreferrer"><?php echo htmlspecialchars($row['source_name']); ?> <i class="fa-solid fa-external-link-alt fa-xs"></i></a>
                                    <?php else: ?>
                        ...
                        <p class="card-description"><?php echo nl2br(htmlspecialchars($row['description'])); ?></p>
                    </div>
