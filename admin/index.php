...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .main-header span a { color: var(--secondary-text); text-decoration: none; font-weight: 500; }

        main { flex-grow: 1; padding: 40px; max-width: 1400px; margin: 0 auto; width: 100%;}
        ...
        .stat-overview { display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 30px; margin-bottom: 50px; }
        .stat-card {
        ...
        .stat-card:nth-child(1) .icon-wrapper { background: var(--accent-color-1); }
        .stat-card:nth-child(2) .icon-wrapper { background: var(--accent-color-2); }
        .stat-card:nth-child(3) .icon-wrapper { background: var(--accent-color-3); }
        .stat-card:nth-child(4) .icon-wrapper { background: var(--accent-color-4); }
        
        .stat-info .stat-number { font-size: 2.2rem; font-weight: 700; color: var(--primary-text); }
        .stat-info .stat-label { font-size: 0.9rem; color: var(--secondary-text); }

        .section-title { font-size: 1.8rem; font-weight: 700; margin-bottom: 25px; padding-bottom: 10px; border-bottom: 3px solid var(--accent-color-1); display: inline-block; }

        .dashboard-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(260px, 1fr)); gap: 30px; }
        ...
        .grid-item:hover { transform: translateY(-8px); box-shadow: 0 15px 30px rgba(0, 0, 0, 0.15); }
        .grid-item i { font-size: 2.5rem; margin-bottom: 15px; color: var(--accent-color-1); transition: color 0.3s ease; }
        .grid-item:hover i { color: var(--accent-color-2); }
        .grid-item span { font-size: 1.15rem; font-weight: 600; }
...
<body>
    <header class="main-header">
        ...
        <span>સ્વાગત છે, એડમિન! | <a href="../logout.php"><i class="fa-solid fa-right-from-bracket"></i> લોગઆઉટ</a></span>
    </header>
